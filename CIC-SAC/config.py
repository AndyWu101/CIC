...
# 一般設定
parser.add_argument("--algorithm", default="CIC-SAC", help="演算法名稱")
...
parser.add_argument("--start_steps", default=10000, type=int, help="最開始使用隨機 action 進行探索")
...
# CIC設定
parser.add_argument("--initial_evaluations", default=1, type=int, help="第一次評估時玩幾局")
parser.add_argument("--max_evaluations", default=10, type=int, help="第一名評估次數的上限")
parser.add_argument("--Lambda_buffer_size", default=10, type=int, help="Lambda buffer 的大小")
