...
class LearningCurve:
    ...
    def __init__(self, actor: Actor):
        ...
        self.learning_curve_Lambda_mus = []

        self.actor = actor
        self.Lambda_mu = args.initial_Lambda
    ...
    def test_initial_performance(self):
        ...
        self.learning_curve_Lambda_mus.append(self.Lambda_mu)
    ...
    def save(self):
        ...
        result = {
            ...
            "Learning Curve": {
                ...
                "Lambda_mu": self.learning_curve_Lambda_mus
            }
        }
